    ...
    <div className="flex flex-1 flex-col items-center justify-center p-4">
      <div className="w-full max-w-sm p-8 bg-white rounded-[32px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100/50 flex flex-col gap-8">
        <div className="text-center">
          <h1 className="text-3xl font-serif font-bold text-[var(--color-navy)] tracking-tight">Fiszki</h1>
          <p className="text-[var(--color-graphite)] mt-2">Zaloguj się do swojego konta</p>
        </div>
        ...
        <div className="text-center text-sm text-[var(--color-graphite)]">
          Nie masz konta?{' '}
          <Link href="/register" className="text-[var(--color-navy)] font-semibold hover:text-[var(--color-gold)] transition-colors duration-200">
            Zarejestruj się
          </Link>
        </div>
      </div>
